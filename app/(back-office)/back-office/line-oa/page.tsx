...
import { listLineConnectedCustomers } from "@/modules/line-oa/queries/list-line-connected-customers";
...
export default async function LineOAPage() {
  ...
  const [templates, staffTemplate, customers] = await Promise.all([
    listAppointmentStatusTemplates(),
    getStaffAppointmentStatusTemplate(),
    listLineConnectedCustomers(),
  ]);
