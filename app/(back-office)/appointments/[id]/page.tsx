...
import { getAppointmentDetail } from "@/modules/appointment/actions/get-appointment-detail";
...
export default async function AppointmentDetailPage({
  ...
  return (
    <>
      <SiteHeader title="รายละเอียดนัดหมาย" />
      <div className="p-6">
        <BackButton />

        <main className="space-y-6 mx-auto w-full">
